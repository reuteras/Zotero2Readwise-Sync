...
class Zotero2Readwise:
    ...
    def get_all_zotero_items(self) -> List[Dict]:
        """
        Retrieves all Zotero items of the specified types (notes and/or annotati
ons) that were modified since the specified date.
...
imestamp.
        ...
        Args:
            ...
            since (int): Timestamp in seconds since the Unix epoch. Defaults to
0.
