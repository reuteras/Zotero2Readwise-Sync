...
[![Zotero ➡️ Readwise Automation](https://github.com/reuteras/Zotero2Readwise-Sync/actions/workflows/automation.yml/badge.svg)](https://github.com/reuteras/Zotero2Readwise-Sync/actions/workflows/automation.yml)
...
```yaml
  schedule:
    - cron: "0 4,16 * * *"
```
*Above is the current schedule set in `.github/workflows/automation.yml`.*
The cron expression means to run the automation **at 04:00 and 16:00 UTC every day**.
